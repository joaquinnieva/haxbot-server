const futsal = `{
  ...
  vertexes: [
    ...
    { x: 590, y: 80, cMask: ['red', 'blue', 'ball'], trait: 'goalNet', curve: 0, color: 'F8F8F8', pos: [700, 80] },
    { x: 550, y: 80, cMask: ['red', 'blue', 'ball'], trait: 'goalNet', curve: 0, color: 'F8F8F8', pos: [700, 80] },
    { x: -550, y: 80, bCoef: 1.25, cMask: ['ball'], trait: 'ballArea', color: 'F8F8F8', pos: [-700, 80] },
    { x: -550, y: 240, bCoef: 1.25, cMask: ['ball'], trait: 'ballArea', color: 'F8F8F8' },
    { x: -550, y: -80, bCoef: 1.25, cMask: ['ball'], trait: 'ballArea', color: 'F8F8F8', pos: [-700, -80] },
    { x: -550, y: -240, bCoef: 1.25, cMask: ['ball'], trait: 'ballArea', color: 'F8F8F8' },
    { x: -550, y: 240, bCoef: 1, cMask: ['ball'], trait: 'ballArea' },
    { x: 550, y: 240, bCoef: 1, cMask: ['ball'], trait: 'ballArea' },
    { x: 550, y: 80, bCoef: 1.25, cMask: ['ball'], trait: 'ballArea', pos: [700, 80] },
    { x: 550, y: 240, bCoef: 1.25, cMask: ['ball'], trait: 'ballArea' },
    { x: 550, y: -240, bCoef: 1.25, cMask: ['ball'], trait: 'ballArea', color: 'F8F8F8' },
    { x: 550, y: -80, bCoef: 1.25, cMask: ['ball'], trait: 'ballArea', color: 'F8F8F8', pos: [700, -80] },
    { x: 550, y: -240, bCoef: 0, cMask: ['ball'], trait: 'ballArea' },
    { x: 550, y: -240, bCoef: 0, cMask: ['ball'], trait: 'ballArea' },
    { x: -550, y: -240, bCoef: 1, cMask: ['ball'], trait: 'ballArea', curve: 0 },
    { x: 550, y: -240, bCoef: 1, cMask: ['ball'], trait: 'ballArea', curve: 0 },
    { x: 0, y: -240, bCoef: 0.1, cMask: ['red', 'blue'], cGroup: ['redKO', 'blueKO'], trait: 'kickOffBarrier' },
    { x: 0, y: -80, bCoef: 0.1, cMask: ['red', 'blue'], cGroup: ['redKO', 'blueKO'], trait: 'kickOffBarrier' },
    { x: 0, y: 80, bCoef: 0.1, cMask: ['red', 'blue'], cGroup: ['redKO', 'blueKO'], trait: 'kickOffBarrier' },
    { x: 0, y: 240, bCoef: 0.1, cMask: ['red', 'blue'], cGroup: ['redKO', 'blueKO'], trait: 'kickOffBarrier' },
    { x: 0, y: -80, bCoef: 0.1, cMask: ['red', 'blue'], trait: 'kickOffBarrier', vis: true, color: 'F8F8F8' },
    { x: 0, y: 80, bCoef: 0.1, cMask: ['red', 'blue'], trait: 'kickOffBarrier', vis: true, color: 'F8F8F8' },
    { x: 0, y: 80, trait: 'kickOffBarrier', color: 'F8F8F8', vis: true, curve: -180 },
    { x: 0, y: -80, trait: 'kickOffBarrier', color: 'F8F8F8', vis: true, curve: -180 },
    { x: 0, y: 80, trait: 'kickOffBarrier', color: 'F8F8F8', vis: true, curve: 0 },
    { x: 0, y: -80, trait: 'kickOffBarrier', color: 'F8F8F8', vis: true, curve: 0 },
    { x: -557.5, y: 80, bCoef: 0.1, cMask: ['ball'], trait: 'ballArea', curve: 0, vis: false, pos: [-700, 80] },
    { x: -557.5, y: 240, bCoef: 2, cMask: ['ball'], trait: 'ballArea', curve: 0, vis: false },
    { x: -557.5, y: -240, bCoef: 2, cMask: ['ball'], trait: 'ballArea', vis: false, curve: 0 },
    { x: -557.5, y: -80, bCoef: 0.1, cMask: ['ball'], trait: 'ballArea', vis: false, curve: 0, pos: [-700, -80] },
    { x: 557.5, y: -240, bCoef: 2, cMask: ['ball'], trait: 'ballArea', vis: false, curve: 0 },
    { x: 557.5, y: -80, bCoef: 0.1, cMask: ['ball'], trait: 'ballArea', vis: false, curve: 0, pos: [700, -80] },
    { x: 557.5, y: 80, bCoef: 0.1, cMask: ['ball'], trait: 'ballArea', curve: 0, vis: false, pos: [700, 80] },
    { x: 557.5, y: 240, bCoef: 2, cMask: ['ball'], trait: 'ballArea', curve: 0, vis: false },
  ...
  playerPhysics: { bCoef: 0, acceleration: 0.11, kickingAcceleration: 0.083, kickStrength: 4.5 },
